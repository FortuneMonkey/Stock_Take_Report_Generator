...
CONFIG_FILE = r"C:\Users\saputra\Projects\admin\Quarter_Report\Code\config.json"
...
def auto_remarks(store_name, data, cfg):
    ...
    if total_var == 0:
        perf   = perf_override   if perf_override   is not None else \
                 f"{store_name} successfully managed to perform Zero Variance at {quarter} stock takes."
